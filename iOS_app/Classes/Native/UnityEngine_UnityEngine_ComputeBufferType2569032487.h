...
struct  ComputeBufferType_t2569032487 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ComputeBufferType_t2569032487, ___value___1)); }
